...
!    open(50, file = 'in1.txt', iostat=io, status='old')
    open(50, file = 'in1_38.txt', iostat=io, status='old')
...
!        No = 325
!    open(50, file = 'in1.txt', iostat=io, status='old')
    open(50,file='in1_38.txt',status='old')
        do i=1, No
            read(50,*) Q(i)
!            write(*,*) Q(i)
        end do
...
!    open(60, file = 'in2.txt', iostat=io, status='old')
!    open(70, file = 'out.txt', iostat=io, status='old')
    open(60,file='in2_38.txt',status='old')
    open(70,file='out_38.txt',status='new')
